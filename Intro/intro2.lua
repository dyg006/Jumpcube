...
-- -----------------------------------------------------------------------------------
 ...
 local function ToMenu()
  composer.gotoScene("Intro.intro3",{effect="crossFade"})
end
...
function scene:create( event )
 ...
 bg=display.newImage(sceneGroup,"Intro/ImmaginiIntro/intro2.jpg",display.contentCenterX,display.contentCenterY)
bg.width=display.contentWidth*1.18
bg.height=display.contentHeight*1.1

local text = display.newText( sceneGroup,  "Why can't I remember anything?", display.contentCenterX, display.contentCenterY, native.systemFont, 32 )
            text:setFillColor( 5 )
