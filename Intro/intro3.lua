...
-- -----------------------------------------------------------------------------------
 ...
 local function ToMenu()
  composer.gotoScene("Intro.intro4",{effect="crossFade"})
end
...
user.firstStart=false
 ...
 bg=display.newImage(sceneGroup,"Intro/ImmaginiIntro/forest.jpg",display.contentCenterX,display.contentCenterY)
bg.width=display.contentWidth*1.18
bg.height=display.contentHeight*1.1

local text = display.newText( sceneGroup,  "I think I'm far from home...", display.contentCenterX*0.78, display.contentHeight*0.55, native.systemFont, 32 )
            text:setFillColor( 5 )
