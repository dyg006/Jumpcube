...
-- -----------------------------------------------------------------------------------
 ...
 local function ToMenu()
  composer.gotoScene("Fine.finaleStoria2",{effect="crossFade"})
end
...
function scene:create( event )
 ...
 bg=display.newImage(sceneGroup,"Fine/ImmaginiFINE/finale1.jpg",display.contentCenterX,display.contentCenterY)
bg.width=display.contentWidth*1.18
bg.height=display.contentHeight*1

local text = display.newText( sceneGroup,  "I see something over there...\n", display.contentCenterX, display.contentCenterY, native.systemFont, 32 )
            text:setFillColor( 5 )
...
cube=display.newImage(sceneGroup,"Fine/ImmaginiFINE/playerSatisfied.png",0,1)
cube.sizex = 200
cube.sizey = 5
cube.x=display.contentCenterX*0.30
cube.y=display.contentHeight*0.78
cube:scale(0.8,0.8)
cube.rotate =45
