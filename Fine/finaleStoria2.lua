...
-- -----------------------------------------------------------------------------------
 ...
 local function ToMenu()
  composer.gotoScene("Fine.finaleStoria3",{effect="crossFade"})
end
...
function scene:create( event )
 ...
 bg=display.newImage(sceneGroup,"Fine/ImmaginiFINE/finale2.jpeg",display.contentCenterX,display.contentCenterY)
bg.width=display.contentWidth*1.18
bg.height=display.contentHeight*1


local text = display.newText( sceneGroup,  "That is my town!", display.contentCenterX*0.45, display.contentHeight*0.40, native.systemFont, 32 )
            text:setFillColor( 5 )
--local text = display.newText( sceneGroup,  "That is my town!", display.contentCenterX, display.contentCenterY, native.systemFont, 32 )
--            text:setFillColor( 5 )
